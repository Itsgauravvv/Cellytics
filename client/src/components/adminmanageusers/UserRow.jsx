  ...
  return (
    <tr className="border-t transition hover:bg-gray-50">
      ...
      <td className="p-3 flex justify-center gap-3 text-lg">
        {isEditing ? (
          <>
            <button onClick={() => saveEdit(u._id)} className="text-green-600 hover:text-green-800">Save</button>
            <button onClick={cancelEdit} className="text-gray-600 hover:text-black">Cancel</button>
          </>
        ) : (
          <>
