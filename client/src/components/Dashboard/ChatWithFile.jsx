...
>
      ...
      <div className="space-y-6">
        <div>
          ...
          <select
            className="w-full p-2 border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black cursor-pointer"
          ...
          >
            ...
            <div className="mt-6 flex gap-4 flex-wrap">
              <button
                ...
                className="px-4 py-2 bg-gray-900 text-white rounded hover:bg-green-700 cursor-pointer"
              >
                 Download PDF
              </button>
              <button
