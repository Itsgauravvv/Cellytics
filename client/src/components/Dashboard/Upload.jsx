  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="px-4 sm:px-6 md:px-8 py-10 min-h-screen bg-gray-900 flex justify-center items-center"
      >
        ...
        <motion.form
          ...
          animate="visible"
          variants={fadeInUp}
          className="bg-white/24 backdrop-blur-md p-6 sm:p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-md"
        >
          <motion.h2
            custom={0}
            initial="hidden"
            animate="visible"
            variants={fadeInUp}
            className="text-xl sm:text-2xl font-bold text-center text-white mb-2 outfit"
          >
            {t("upload.title")}
          </motion.h2>
          ...
          <motion.p
            ...
            animate="visible"
            variants={fadeInUp}
            className="text-center text-xs sm:text-sm text-white mb-6"
          >
          ...
          <motion.button
            ...
            variants={fadeInUp}
            type="submit"
            className="w-full bg-gray-900 text-white py-2 rounded-xl shadow-md hover:bg-green-600 transition duration-200"
          >
