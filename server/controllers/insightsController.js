...
Someone shared AI-generated insights with you via Cellytics.
...
You received this email because someone used Cellytics to share insights with you.`;

    const htmlMessage = `
      <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        <p>Hi,</p>
        <p>Someone shared AI-generated insights with you via <strong>Cellytics</strong>.</p>
        <p>
        ...
        <p>Best regards,<br>Cellytics Team</p>
        <hr>
        <small>You received this email because someone used Cellytics to share insights with you.</small>
      </div>
    `;

    await sendEmail({
      to: email,
      subject: "AI Insights Shared with You via Cellytics",
      text: textMessage,
      html: htmlMessage,
    });
